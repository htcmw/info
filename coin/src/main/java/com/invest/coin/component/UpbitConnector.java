...
import com.invest.coin.client.UpbitFeignClient;
import com.invest.coin.client.dto.CryptoCurrencyCautionDto;
...
import com.invest.coin.entity.*;
import com.invest.coin.entity.embeddable.CoinName;
import com.invest.coin.repository.*;
...
public class UpbitConnector {
    ...
    //    @Async
    @Transactional
    public void getAllCointAllMarket() {
        UpbitCoinListResponseDto coinInfoList = upbitFeignClient.getAllCointAllMarket(true);
